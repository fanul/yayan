            ...
            <div class="shell">
                ...
                <div id="navigation">
                    <ul>
                        ...
                        <li><a href="http://localhost/titipan/yayan/random/" class="active"><span>Random</span></a></li>
            ...
            <div class="shell">
                ...
                <div id="main">
                    ...
                    <div class="box">
                        ...
                        <p>
                            <form action="http://localhost/titipan/yayan/random/" method="post">
                                <div class="form">
                                    <p>
                                        Pilih Proyek
                    ...
                    <?php if ($_SERVER["REQUEST_METHOD"] == "POST") { ?>
                        ...
                        <div class="box">
                            <!-- Box Head -->
                            <div class="box-head">
                                <h2 class="left">Random Geezer</h2>
                            </div>
                            <!-- End Box Head -->	
