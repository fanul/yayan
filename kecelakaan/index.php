            ...
            <div class="shell">
                ...
                <div id="navigation">
                    <ul>
                        ...
                        <li><a href="http://localhost/titipan/yayan/kecelakaan/" class="active"><span>Kecelakaan</span></a></li>
                            ...
                            if (isset($_SESSION['user_nama']) && isset($_GET['id'])) {
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        <form action="http://localhost/titipan/yayan/kecelakaan/edit.php" method="post">
                                            <div class="form">
                                                <p><br><input type="hidden" name="id_kegiatan" value="<?php echo $_GET['id']; ?>"></p>
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <!-- Box Head -->
                                                            <div class="box-head">
                                                                <h2>Tambah - Kecelakaan</h2>
                                                            </div>
                                                            <!-- End Box Head-->

                                                            <div class="box-content">
                                                                <form action="http://localhost/titipan/yayan/kecelakaan/tambah.php" method="post">
                                                                    <div class="form">
                                                                        <p>
                                                                            Pilih Proyek
                                                                            <select name="id_proyek">
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="table">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <?php
                                                                    $index = 1;
                                                                    $result = mysql_query("SELECT * from laporan_kecelakaan") or die("Query failed with error: " . mysql_error());
                                                                    while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                                                        ?>
                                                                        <tr <?php if ($index % 2 == 0)
                                                                        echo 'class="odd"'; ?>>
                                                                            ...
                                                                            <td><h3><?php echo $row['NAMA_LAPORAN_KECELAKAAN'] ?></h3></td>
                                                                            <td><h3><?php echo $row['TANGGAL_LAPORAN_KECELAKAAN'] ?></h3></td>
                                                                            <td><h3><?php echo $row['JUMLAH_LAPORAN_KECELAKAAN'] ?></h3></td>
                                                                            <?php
                                                                            if (isset($_SESSION['user_nama'])) {
                                                                                ?>
                                                                                <td>
                                                                                    <a href="<?php echo 'http://localhost/titipan/yayan/kecelakaan/delete.php?id=' . $row['ID_LAPORAN_KECELAKAAN']; ?>" class="ico del">Delete</a>
                                                                                    <a href="
                                                                                    <?php
                                                                                    echo 'http://localhost/titipan/yayan/kecelakaan/index.php?id=' .
                                                                                    $row['ID_LAPORAN_KECELAKAAN'] . '&nama=' . $row['NAMA_LAPORAN_KECELAKAAN']
                                                                                    . '&tanggal=' . $row['TANGGAL_LAPORAN_KECELAKAAN']
                                                                                    . '&jumlah=' . $row['JUMLAH_LAPORAN_KECELAKAAN']
                                                                                    . '&proyek=' . $pr;
                                                                                    ;
