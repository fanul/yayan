            ...
            <div class="shell">
                ...
                <div id="navigation">
                    <ul>
                        ...
                        <li><a href="http://localhost/titipan/yayan/kegiatan/" class="active"><span>Kegiatan</span></a></li>
                            ...
                            if (isset($_SESSION['user_nama']) && isset($_GET['id'])) {
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-content">
                                        <form action="http://localhost/titipan/yayan/kegiatan/edit.php" method="post">
                                            <div class="form">
                                                <p><br><input type="hidden" name="id_kegiatan" value="<?php echo $_GET['id']; ?>"></p>
                                                            ...
                                                            <p>
                                                                ...
                                                                <select name="nama_kegiatan">
                                                                    ...
                                                                    <option value="inspeksi k3">inspeksi k3</option>
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="box-content">
                                                                <form action="http://localhost/titipan/yayan/kegiatan/tambah.php" method="post">
                                                                    <div class="form">
                                                                        <p>
                                                                            Pilih Proyek
                                                                            <select name="id_proyek">
                                                        ...
                                                        <div class="box">
                                                            ...
                                                            <div class="table">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <?php
                                                                    $index = 1;
                                                                    $result = mysql_query("SELECT * from progress_kegiatan") or die("Query failed with error: " . mysql_error());
                                                                    while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
                                                                        ?>
                                                                        <tr <?php if ($index % 2 == 0)
                                                                        echo 'class="odd"'; ?>>
                                                                            ...
                                                                            <td><h3><?php echo $row['NAMA_PROGRES_KEGIATAN'] ?></h3></td>
                                                                            <td><h3><?php echo $row['TANGGAL_PROGRES_KEGIATAN'] ?></h3></td>
                                                                            <td><h3><?php echo $row['JUMLAH_PROGRES_KEGIATAN'] ?></h3></td>
                                                                            <?php
                                                                            if (isset($_SESSION['user_nama'])) {
                                                                                ?>
                                                                                <td>
                                                                                    <a href="<?php echo 'http://localhost/titipan/yayan/kegiatan/delete.php?id=' . $row['ID_PROGRES_KEGIATAN']; ?>" class="ico del">Delete</a>
                                                                                    <a href="
                                                                                    <?php
                                                                                    echo 'http://localhost/titipan/yayan/kegiatan/index.php?id=' .
                                                                                    $row['ID_PROGRES_KEGIATAN'] . '&nama=' . $row['NAMA_PROGRES_KEGIATAN']
                                                                                    . '&tanggal=' . $row['TANGGAL_PROGRES_KEGIATAN']
                                                                                    . '&jumlah=' . $row['JUMLAH_PROGRES_KEGIATAN']
                                                                                    . '&proyek=' . $pr;
                                                                                    ;
