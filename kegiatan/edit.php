...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $exec = mysql_query("UPDATE progress_kegiatan
                        SET nama_progres_kegiatan = '$nama_kegiatan',
                        id_proyek = '$id_proyek', 
                        jumlah_progres_kegiatan = '$jumlah_kegiatan',
                        tanggal_progres_kegiatan = '$tanggal_kegiatan' 
                         where id_progres_kegiatan ='$id_kegiatan'") or die(mysql_error());
